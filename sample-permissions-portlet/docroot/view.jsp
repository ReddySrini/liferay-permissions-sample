...
<c:choose>
	<c:when test="<%= permissionChecker.hasPermission(groupId, name, primKey, actionId) %>">
		Yes
		<img alt="YES" src="http://clareitysecurity.com/wp-content/uploads/2011/12/success.jpg"/>
	</c:when>
	<c:otherwise>
		No
		<img alt="NO" src="http://brainsyndicate.files.wordpress.com/2011/05/stop_hand.png"/>
	</c:otherwise>
</c:choose>
